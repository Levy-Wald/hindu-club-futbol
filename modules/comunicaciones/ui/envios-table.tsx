...
import { reenviarEnvio } from '@/modules/comunicaciones/lib/actions'
...
export function EnviosTable({ envios: initialEnvios }: { envios: Envio[] }) {
  ...
  return (
    <div className="space-y-4" data-testid="envios-section">
      {/* Filtros */}
              ...
              <Table>
                ...
                <TableBody>
                  {filtrados.map((e) => {
                    ...
                    const isMock = e.metadata?.mock === true

                    return (
                      <TableRow key={e.id} data-testid="envios-row">
