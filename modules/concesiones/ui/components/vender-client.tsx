...
import { registrarVenta } from '@/modules/concesiones/lib/actions'
        ...
        <div className="space-y-3">
          <Card>
            <CardContent className="pt-4 space-y-3">
              ...
              {cart.length === 0 ? (
                <p className="text-sm text-muted-foreground py-4 text-center">Agrega productos tocando las tarjetas</p>
              ) : (
