import { listarProductos, listarPuntosVenta, obtenerConcesionario } from '@/modules/concesiones/lib/actions'
import { VenderClient } from '@/modules/concesiones/ui/components/vender-client'
