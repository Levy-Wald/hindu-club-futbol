...
const ATRIBUTO_COLORS: Record<string, string> = {
  ...
  'sistema.admin': 'bg-error-500/10 text-error-500',
  'sistema.soporte': 'bg-error-500/10 text-error-400',
  'tenant.admin': 'bg-warning-500/10 text-warning-500',
  'tenant.admin_padron': 'bg-warning-500/10 text-warning-400',
  'tenant.staff': 'bg-info-500/10 text-info-500',
  'tenant.editor': 'bg-indigo-500/10 text-indigo-500',
  'finanzas.admin': 'bg-success-500/10 text-success-500',
  'finanzas.tesorero': 'bg-success-500/10 text-success-400',
  'rrhh.admin': 'bg-info-500/10 text-info-400',
  'rrhh.empleado': 'bg-info-500/10 text-info-300',
  'operaciones.coordinador': 'bg-success-500/10 text-success-400',
  'operaciones.scout': 'bg-success-500/10 text-success-300',
  'comunicaciones.editor': 'bg-fuchsia-500/10 text-fuchsia-500',
  // Tronco (sin namespace)
  jugador: 'bg-info-500/10 text-info-500',
  capitan: 'bg-warning-500/10 text-warning-500',
  dt: 'bg-success-500/10 text-success-500',
  dirigente: 'bg-purple-500/10 text-purple-500',
  socio: 'bg-info-500/10 text-info-400',
