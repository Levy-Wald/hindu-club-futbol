  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">Transferir fondos entre cajas</p>
      </div>

      <div className="border rounded-lg p-8 text-center text-muted-foreground">
        <ArrowRightLeft className="h-12 w-12 mx-auto mb-4 opacity-30" />
        <p className="font-medium">Formulario de transferencia entre cajas</p>
        <p className="text-sm mt-1">Selecciona caja origen, caja destino, monto y concepto.</p>
