import { aceptarInvitacionAction } from '@/modules/eventos/lib/actions'
import { redirect } from 'next/navigation'
import { createServiceRoleClient } from '@/lib/supabase/service-role'

export default async function AceptarInvitacionPage(props: {
  ...
  const result = await aceptarInvitacionAction(token)

  if (result.ok) {
    redirect(`/admin/${evento?.tenant_id ?? 'hindu'}/calendario?evento_confirmado=${eventoId}`)
  }
