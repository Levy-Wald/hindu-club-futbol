  ...
  collapsibles: [
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: 'Conciliacion', href: '/admin/finanzas/conciliacion', icon: ArrowLeftRight },
        ...
        { label: 'Conciliacion bancaria', href: '/admin/finanzas/reportes/conciliacion', icon: ArrowLeftRight },
