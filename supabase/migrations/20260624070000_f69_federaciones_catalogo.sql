-- F6.9 — Federaciones: registrar módulo en catálogo + activar tenant.
...
VALUES (
  ...
  'Federaciones/asociaciones y los equipos del club afiliados a cada una',
  'vertical_ccbp', 'cross_vertical',
  '/admin/federaciones', 'Network', 'actividad', 'Competencias', 5,
...
VALUES ('11111111-1111-1111-1111-111111111111', 'federaciones', true, now())
ON CONFLICT (tenant_id, modulo_slug) DO UPDATE SET activo = true, fecha_desactivacion = NULL;

-- ROLLBACK:
--   DELETE FROM tenant_modulos WHERE tenant_id='11111111-1111-1111-1111-111111111111' AND modulo_slug='federaciones';
--   DELETE FROM catalogo_modulos WHERE slug='federaciones';
