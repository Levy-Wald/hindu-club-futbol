...
3. Leer docs relevantes segun la tarea:
   ...
   - Nuevos modulos → `docs/ARCHITECTURE.md`
...
git diff --stat
```
Revisar cada archivo modificado por:
- Cambios no intencionales
- Error handling faltante
- Edge cases no cubiertos
- Archivos que no deberian haber cambiado
...
2. **docs/** — Si se establecio un patron nuevo o se tomo una decision arquitectonica, documentarla.
3. **README.md** — Si se agrego un modulo nuevo o cambio la estructura, actualizarlo.
...
- Templates pre-aprobados para mensajes salientes.
