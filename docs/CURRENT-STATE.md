...
| Indicador | Valor |
|---|---|
| Tag git actual | `v0.46.5-portal-editar-contacto` (F3.1 núcleo + cierre fino). Previo: `v0.46.4-portal-agenda`, `v0.46.3-portal-notif-login`, `v0.46.2`, `v0.46.1`, `v0.46.0`, serie cierre-fino-F1 v0.45.x |
